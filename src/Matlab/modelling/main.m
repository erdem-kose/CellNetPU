clear;clc;
%reading image
temp_im=imread('images/lara.png','png');
...
[ A,B,I,x_bnd,u_bnd ]=cnn_template(4,0.2);
[x,x_normal] = cnn_system( A,B,I,x_bnd,u_bnd, u, x, Ts, iter, 0);

[ A,B,I,x_bnd,u_bnd ]=cnn_template(8,0);
[x,x_normal] = cnn_system( A,B,I,x_bnd,u_bnd, x, 0, Ts, iter, 0);

[ A,B,I,x_bnd,u_bnd ]=cnn_template(11,6);
[x,x_normal] = cnn_system( A,B,I,x_bnd,u_bnd, x, x, Ts, iter, 0);
