...
[x_new,x_normal_japan,~] = cnn_system( A,B,I,x_bnd,u_bnd, u, x_past, Ts, 2000, 1);
...
x_new=0;
for i=1:learn_loop
    [x_new,~,cpu_time_temp] = cnn_system( A,B,I,x_bnd,u_bnd, u, x_new, Ts, iter, 1);
...
[x_new,x_normal_switz,~] = cnn_system( A,B,I,x_bnd,u_bnd, u, x_new, 1, 1000, 1);
