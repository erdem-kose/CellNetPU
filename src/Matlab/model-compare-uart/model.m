...
gray_im=imresize(gray_im,[128 256]);
...
[x,~,~] = cnn_system( A,B,I,x_bnd,u_bnd, u, 0, Ts, iter, 1);

[ A,B,I,x_bnd,u_bnd ]=cnn_template(4,0.3);
[x,~,~] = cnn_system( A,B,I,x_bnd,u_bnd, u, x, Ts, iter, 1);

[ A,B,I,x_bnd,u_bnd ]=cnn_template(8,0);
[x,~,~] = cnn_system( A,B,I,x_bnd,u_bnd, x, 0, Ts, iter, 1);

[ A,B,I,x_bnd,u_bnd ]=cnn_template(11,6);
[x,~,~] = cnn_system( A,B,I,x_bnd,u_bnd, x, x, Ts, iter, 1);

[ A,B,I,x_bnd,u_bnd ]=cnn_template(7, 0);
[x,~,~] = cnn_system( A,B,I,x_bnd,u_bnd, x, 0, Ts, iter, 1);

[ A,B,I,x_bnd,u_bnd ]=cnn_template(13,[1 0 1;0 1 0;1 0 1]);
[x,x_normal,~] = cnn_system( A,B,I,x_bnd,u_bnd, x, 0, Ts, iter, 1);
