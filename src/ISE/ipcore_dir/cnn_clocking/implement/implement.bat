...
xst -ifn xst.scr
move cnn_clocking_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cnn_clocking_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cnn_clocking_exdes.ucf cnn_clocking_exdes

echo 'Running map'
map -timing -pr b cnn_clocking_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm cnn_clocking_exdes -w routed.ncd routed.vhd
cd ..
